...
# add_note Ненавижу чай. Это же просто грязная жижа. Больше того, чай — одна из главных причин падения Британской империи.
# add_note Почему люди, которые не слушают чужих советов, так любят давать собственные?
# add_note Власть меняется — ложь остается.

# add_note_tag 1 чай причина
# add_note_tag 2 советы люди
# add_note_tag 3 власть ложь

# add_contact Serhii 0954703544 serhii.zhukov@ukr.net 24.06.1985
# add_contact Alex 80951016570 a.alex@ukr.net 29.02.1985
# add_address Serhii Ukraine,Odessa,Street,1
# add_address Alex Ukraine,Kiev
# 0  show_all_contacts

# 1 add_contact Serhii   

# 2 add_phone Serhii 0954703544
